...
|get_other_user_info| user_id |user_id, user_name, email, gender, resident_city_id, comment, is_friend, status| |
|get_other_user_travel_group_id| user_id|[travel_group_id], status |
