...
|   √   | get_travel_info | user_id, session_id, travel_id                                                               | city_id, city: {city_id, city_name, ...}, date_start, date_end, visibility, travel_note, status | date 格式 "yyyy-mm-dd"                                                                                                                                                                                                   |
...
|   √   | search_user_info_list_by_user_name  | user_id, session_id, query_user_name              | count, [user_info_list], status                                                                                                                             | user_info_list 内含 user_info                                                                                                                   |
...
|   √   | get_travel_msg_list | user_id, session_id         | count, [travel_msg_list: {msg_id, user_id, friend_user_id, friend_travel_id, msg_type, msg_content}], status | 返回用户所有的行程关联消息（邀请加入行程/加入行程/离开行程/修改行程/删除行程）, msg_type in ['I', 'A', 'L', 'M', 'D'] |
