...
| :---: | :------------- | :----------------------------------------------------------- | :------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------- |
|   √   | register       | email, pswd_hash, user_name, gender, resident_city_id        | user_id, status                                                                        | comment 自动置为空串, city_id=1对应于未设置, gender in ['M', 'F', 'U', 'O']                                           |
...
|   ×   | del_friend_msg | user_id, session_id, friend_msg_id                           |                                                                                        | 删除用户处理过的好友消息，如果同意添加好友则需同时调用 add_friend                                                     |
...
|   √   | get_travel_group_info   | user_id, session_id, travel_group_id                                                           | travel_group_name, travel_group_note, travel_group_color, status | color 是 7 位 char (#FFFFFF)                                              |
...
|   ×   | move_travel             | user_id, session_id, travel_group_id, travel_id, new_travel_group_id                           | status                                                           |                                                                           |
...
|   √   | get_friend_user_info         | user_id, session_id, friend_user_id              | user_id, user_name, gender, resident_city_id, comment, friend_note, status              |                                                                                                                                               |
|   √   | get_others_user_info         | user_id, session_id, other_user_id               | user_id, user_name, (friend_note,) gender, resident_city_id, comment, is_friend, status |                                                                                                                                               |
