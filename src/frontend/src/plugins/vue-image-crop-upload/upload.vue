    ...
    <div class="vue-image-crop-upload" v-show="value">
        <div class="vicp-wrap">
            ...
            <div class="vicp-step1" v-show="step == 1">
                <div @click="handleClick" @dragenter="preventDefault" @dragleave="preventDefault"
                     @dragover="preventDefault" @drop="handleChange" class="vicp-drop-area">
                ...
                <div class="vicp-crop">
                    <div class="vicp-crop-left" v-show="true">
                        ...
                        <div class="vicp-range">
                            <input :value="scale.range" @mousemove="zoomChange" max="100" min="0" step="1" type="range">
            ...
            <div class="vicp-step3" v-if="step == 3">
                <div class="vicp-upload">
                    ...
                    <div class="vicp-progress-wrap">
                        <span :style="progressStyle" class="vicp-progress" v-show="loading === 1"></span>
                    </div>
                    <div class="vicp-error" v-show="hasError">
                        <i class="vicp-icon2"></i> {{ errorMsg }}
                    </div>
            ...
            <canvas :height="height" :width="width" ref="canvas" v-show="false"></canvas>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            upload() {
                let that = this,
                    ...
                    fmData = new FormData();
                console.log('field test', this.field);
                ...
                new Promise(function (resolve, reject) {
                    ...
                    axios.post(url, fmData).then(function (response) {
                    ...
                    function (resData) {
                        if (that.value) {
                            that.loading = 2;
                            that.$emit('crop-upload-success', resData.data, field, ki);
                        }
                    },
                    // 上传失败
                    function (sts) {
