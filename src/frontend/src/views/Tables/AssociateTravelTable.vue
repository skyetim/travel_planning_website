  ...
  <div class="card shadow">
    <div class="card-header border-0">
      <div class="row align-items-center">
        ...
        <div class="col text-right"><small>{{hasAssociate()?"": "还没有关联行程哦~快去寻找伙伴吧"}}</small></div>
      </div>
    </div>
    <div class="table-responsive">
      ...
      >
        ...
        <template slot-scope="{row}">
          <th scope="row">
            <base-button type="primary" size="sm" @click="leave_travel(row)">取消同行</base-button>
          </th>
          ...
          <td>
            <div class="avatar-group">
              ...
              >
                <img alt="Image placeholder" :src="row.owner_avatar_url">
              </a>
            </div>
          </td>
        </template>
