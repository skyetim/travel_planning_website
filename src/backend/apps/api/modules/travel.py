...
from apps.api.modules.user import get_user_instance_by_id, check_user_existance
...
class Travel(object):
    ...
    def add_company(self, company_user_id):
        cuser = get_user_instance_by_id(company_user_id)
    ...
    def move_to_new_travel_group(self, travel_group_name, travel_group_note, travel_group_color):
        new_travel_group = TravelGroup.new_travelgroup(
                user_id=self.user_id, travel_group_name=travel_group_name, travel_group_note=travel_group_note,
...
class TravelGroup(object):
    ...
    def add_new_travel(self, travel_note, city_id, date_start, date_end, visibility, company_user_id_list):
        ...
        ), travel_note=travel_note, city_id=city_id, date_start=date_start, date_end=date_end, visibility=visibility,
